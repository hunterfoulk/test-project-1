...
export default function Home() {
  ...
  return (
    ...
    <div className="min-h-screen w-full flex flex-col items-center bg-white font-mono">
      ...
      {/* Header */}
      <div className="w-full bg-white max-w-[1500px] flex mt-20 rounded-lg py-2 bg-green-400 flex-wrap">
      ...
      <div className="w-full max-w-[1500px] flex justify-around my-[120px] flex-wrap py-10 ">
        <div className="card min-w-[280px] max-w-[280px] shadow-lg rounded-lg py-3 mb-3" style={{ boxShadow: "0 8px 18px 1px #d3d3d3" }}>
          <div className="flex max-h-[200px] flex justify-center mb-3">
        ...
        <div className="card min-w-[280px] max-w-[280px] rounded-lg py-3 mb-3" style={{ boxShadow: "0 8px 18px 1px #d3d3d3" }} >
